...
a_words <- get_words(
  "vocal_proportion", "closure", 
  pattern_alias = "closed",
  prop = 0.33, min_len = 4, max_len = 9, is_common = T
)
t_words <- get_words(
  "vocal_proportion", "plosives", 
  pattern_alias = "plosives",
  prop = 0.33, min_len = 4, max_len = 9, is_common = T
)
c_words <- get_words(
...
g_words <- get_words(
  "vocal_proportion", "liquids", 
  pattern_alias = "liquids",
  prop = 0.33, min_len = 4, max_len = 9, is_common = T
)
